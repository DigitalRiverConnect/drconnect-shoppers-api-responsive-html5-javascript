...
ns.Session=function(a,b,c){this.apikey=a;b=="1"?(this.connection=new dr.api.connection.DummyConnection,this.authManager=new dr.api.auth.DummyAuthManager):(this.connection=new dr.api.connection.Connection,this.authManager=new dr.api.auth.AuthManager(dr.api.connection.URI.BASE_URL+dr.api.connection.URI.LOGIN,c));this.reset()};ns.Session.prototype.createErrorPromise=function(a){console.log("Operation not allowed: "+a);var a=this.createServerErrorResponse(),b=Q.defer();b.reject(a);return b.promise};
ns.Session.prototype.createDisconnectedError=function(){return this.createErrorPromise("You must be connected to the server in order to use the API")};ns.Session.prototype.createServerErrorResponse=function(){var a={status:500,error:{}};a.error.errors={};a.error.errors.error={code:"server_error",description:"Service Temporaly Unavailable. Please try again later or contact the System Administrator."};return a};
ns.Session.prototype.create=function(a,b){if(!this.connected)return this.createDisconnectedError();var c={};c.Authorization="bearer "+this.token;return this.connection.create(a,b,c).then(function(a){for(var b in a)if(b)return a[b]})};ns.Session.prototype.remove=function(a,b){if(!this.connected)return this.createDisconnectedError();var c={};c.Authorization="bearer "+this.token;b||(b={});b.client_id=this.apikey;return this.connection.remove(a,b,c).then(function(a){for(var b in a)if(b)return a[b]})};
ns.Session.prototype.retrieve=function(a,b){if(!this.connected)return this.createDisconnectedError();var c={};c.Authorization="bearer "+this.token;b||(b={});b.client_id=this.apikey;return this.connection.retrieve(a,b,c).then(function(a){for(var b in a)if(b)return a[b]})};ns.Session.prototype.errorHandle=function(){};
